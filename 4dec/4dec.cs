...
{
    public class December4 : AdventOfCode
    {
        ...
        {
            string fileName = "4dec/input_test.txt";
        ...
        {
            string fileName = "4dec/input.txt";
            var scanner = new PassportScanner(fileName);
            scanner.Scan();
            int validPassports = scanner.NrOfPassportsWithRequiredFields();
        ...
        {
            string fileName = "4dec/input_test2_1.txt";
            var scanner = new PassportScanner(fileName);
            scanner.Scan();
            int validPassports = scanner.NrOfValidPassports();

            string fileName2 = "4dec/input_test2_2.txt";
